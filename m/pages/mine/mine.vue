<template>
	<view class="container">
		...
		<div class="cell">
			<u-cell icon="setting-fill" title="我的考试" :isLink="true" url="/pages/examList/examList" arrow-direction="right">
				<u-image slot="icon" src="@/static/my/index-exam.png" width="16" height="16"></u-image>
			</u-cell>
			<u-cell icon="setting-fill" title="我的模拟" :isLink="true" url="/pages/testList/testList" arrow-direction="right" :border="false">
