...
export const useTabbarStore = defineStore(
	...
	() => {
		const admin = ref([
			...
			{ pagePath: '/pages/admin/profile/profile', text: '个人中心', icon: 'icon-icon-people' }
		]);
		const examUser = ref([
			...
			{ pagePath: '/pages/exam-user/profile/profile', text: '个人中心', icon: 'icon-icon-people' }
		]);
		const markUser = ref([
			{ pagePath: '/pages/mark-user/my-mark/my-mark', text: '阅卷', icon: 'icon-icon-pencil' },
			{ pagePath: '/pages/mark-user/profile/profile', text: '个人中心', icon: 'icon-icon-people' }
		]);
