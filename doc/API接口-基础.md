...
####组织机构模板：api/org/template
######请求参数
无
######响应数据
字节流

####组织机构导入：api/org/import
######请求参数
| 参数     |  类型   |  描述  |  必填 |
| --------   | -----   | -----  | ---- |
|file    | file     |   附件   |   是   |

####组织机构导出：api/org/export
######请求参数
| 参数     |  类型   |  描述  |  必填 |
| --------   | -----   | -----  | ---- |
|ids    | String     |   逗号分隔的ids   |   否   |

####用户列表：api/user/listpage
######请求参数
| 参数     |  类型   |  描述  |  必填 |
| --------   | -----   | -----  | ---- |
| name | String(16) | 名称   |   否     |
