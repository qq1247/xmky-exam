...
public class UserController extends BaseController{
	...
	public String toList() {
		try {
			return "/WEB-INF/jsp/sys/user/userList.jsp";
		} catch (Exception e) {
	...
	public String toAdd() {
		try {
			return "/WEB-INF/jsp/sys/user/userEdit.jsp";
		} catch (Exception e) {
	...
	public String toPostUpdate() {
		try {
			return "/WEB-INF/jsp/sys/user/userPostUpdate.jsp";
		} catch (Exception e) {
	...
	public String toOrgUpdate() {
		try {
			return "/WEB-INF/jsp/sys/user/userOrgUpdate.jsp";
		} catch (Exception e) {
