...
<html>
	...
	<script type="text/javascript">
		...
		function initAuthUserTree(){
			$.ajax({
				url : "home/examType/authUserOrgTreeList",
		...
		function initAuthOrgTree(){
			$.ajax({
				url : "home/examType/authOrgOrgTreeList?id=${id }",
				success : function(arr) {
		...
		function initAuthPostTree(){
			$.ajax({
				url : "home/examType/authPostOrgTreeList?id=${id }",
				success : function(arr) {
					var defaluts = {
						idFiled : "id",
						textFiled : "text", 
		...
		function initAuthUserTable(){
			$authUserTable.bootstrapTable({
				url : "home/examType/authUserList",
		...
		function toAuthUserAddList(){
			BootstrapDialog.show({
				...
				data : {
					"pageToLoad" : "home/examType/toAuthUserAddList?id=${id }"
				},
				buttons : [{
					label : "&nbsp;确定",
				...
				onshown : function(){
					...
					$authUserAddTable.bootstrapTable({
						url : "home/examType/authUserAddList",
						queryParams : function(params){
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/examType/doAuthUserAdd",
										...
										success : function(obj) {
											...
											window.location.href = "home/examType/toAuth?id=${id }";
										}
									});
								}
							}, {
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/examType/doAuthUserDel",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/examType/doAuthOrgUpdate",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/examType/doAuthPostUpdate",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
