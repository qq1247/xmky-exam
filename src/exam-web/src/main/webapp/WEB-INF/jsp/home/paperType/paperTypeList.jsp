...
<html>
	...
	<script type="text/javascript">
		...
		function toAdd(){
			...
			window.location.href = "home/paperType/toAdd?parentId=" + treeNodes[0].ID;
		}
		...
		function toEdit(){
			...
			window.location.href = "home/paperType/toEdit?id=" + nodes[0].ID;
		}
		...
		function toAuth(){
			...
			window.location.href = "home/paperType/toAuth?id=" + nodes[0].ID;
		}
	</script>
</html>