...
public class BigDecimalTypeHandler extends BaseTypeHandler<List<BigDecimal>> {

	@Override
	public void setNonNullParameter(PreparedStatement preparedStatement, int i, List<BigDecimal> list,
	...
	public List<BigDecimal> getNullableResult(ResultSet resultSet, String s) throws SQLException {
		...
		return StringUtil.toBigDecimalList(value);
	}
