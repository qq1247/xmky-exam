		...
		Page<Map<String, Object>> page = selectJoinMapsPage(pageIn.toPage(), //
				new MPJQueryWrapper<MyExam>().setAlias("MY_EXAM")//
						...
						.select("EXAM.ID AS EXAM_ID", "EXAM.NAME AS EXAM_NAME", "EXAM.START_TIME AS EXAM_START_TIME",
								...
								"EXAM.PASS_SCORE AS EXAM_PASS_SCORE", "USER.ID AS USER_ID", "USER.NAME AS USER_NAME",
								"MY_EXAM.ANSWER_START_TIME", "MY_EXAM.ANSWER_END_TIME", "MY_EXAM.TOTAL_SCORE",
								"MY_EXAM.STATE", "MY_EXAM.MARK_STATE", "MY_EXAM.ANSWER_STATE", "MY_EXAM.NO",
