...
public class ExamServiceImpl extends BaseServiceImp<Exam> implements ExamService {
	...
	@Override
	public void addAndUpdate(Exam exam, LoginUser user) {
	...
	@Override
	public void toPaper(Model model, LoginUser loginUser, Integer examId) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void toMark(Model model, LoginUser currentUser, Integer examUserId) {
		// TODO Auto-generated method stub
