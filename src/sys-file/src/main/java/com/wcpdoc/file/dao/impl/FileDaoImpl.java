package com.wcpdoc.file.dao.impl;
...
public class FileDaoImpl extends RBaseDaoImpl<File> implements FileDao {
	...
	public PageOut getListpage(PageIn pageIn) {
		...
		sqlUtil.addWhere(ValidateUtil.isValid(pageIn.get("name")), "FILE.NAME LIKE :FILE.NAME", "%" + pageIn.get("name") + "%");
		sqlUtil.addWhere(ValidateUtil.isValid(pageIn.get("extName")), "FILE.EXT_NAME LIKE :FILE.EXT_NAME", "%" + pageIn.get("extName") + "%");
