...
public class DictDaoImpl extends RBaseDaoImpl<Dict> implements DictDao {
	...
	public PageOut getListpage(PageIn pageIn) {
		...
		sqlUtil.addWhere(ValidateUtil.isValid(pageIn.get("dictIndex")), "DICT.DICT_INDEX LIKE :DICT.DICT_INDEX", "%" + pageIn.get("dictIndex") + "%")
				.addWhere(ValidateUtil.isValid(pageIn.get("dictKey")), "DICT.DICT_KEY LIKE :DICT.DICT_KEY", "%" + pageIn.get("dictKey") + "%")
				.addWhere(ValidateUtil.isValid(pageIn.get("dictValue")), "DICT.DICT_VALUE LIKE :DICT.DICT_VALUE", "%" + pageIn.get("dictValue") + "%")
