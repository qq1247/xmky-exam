 ...
 */
public class VerCheckJob implements Job {
	public void execute(JobExecutionContext context) throws JobExecutionException {
		new Thread(() -> {
			try {
				...
				ResponseEntity<String> response = SpringUtil.getBean(RestTemplate.class)
						.postForEntity(parm.getVerhubUrl(), requestEntity, String.class);
