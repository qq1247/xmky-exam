...
<html>
	<head>
		<title>试卷分类${empty paperType.id ? "添加" : "修改"}</title>
					...
					<div class="panel panel-default">
   						<div class="panel-body">
   							<form id="editForm" class="form-horizontal" role="form">
   								<input type="hidden" id="id" name="id" value="${paperType.id }" />
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" id="name" name="name" value="${paperType.name }"
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" id="no" name="no" value="${paperType.no }"
		...
		function doAdd(){
			...
			$.ajax({
				...
				success : function(obj) {
					...
					window.location.href = "home/paperType/toList";
				}
			});
		}
