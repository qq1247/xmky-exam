...
<html>
	...
	<script type="text/javascript">
		...
		function initAuthUserTree(){
			$.ajax({
				url : "home/questionType/authUserOrgTreeList",
		...
		function initAuthOrgTree(){
			$.ajax({
				url : "home/questionType/authOrgOrgTreeList?id=${id }",
				success : function(arr) {
		...
		function initAuthPostTree(){
			$.ajax({
				url : "home/questionType/authPostOrgTreeList?id=${id }",
				success : function(arr) {
					var defaluts = {
						idFiled : "id",
						textFiled : "text", 
		...
		function initAuthUserTable(){
			$authUserTable.bootstrapTable({
				url : "home/questionType/authUserList",
		...
		function toAuthUserAddList(){
			BootstrapDialog.show({
				...
				data : {
					"pageToLoad" : "home/questionType/toAuthUserAddList?id=${id }"
				},
				buttons : [{
					label : "&nbsp;确定",
				...
				onshown : function(){
					...
					$authUserAddTable.bootstrapTable({
						url : "home/questionType/authUserAddList",
						queryParams : function(params){
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/questionType/doAuthUserAdd",
										...
										success : function(obj) {
											...
											window.location.href = "home/questionType/toAuth?id=${id }";
										}
									});
								}
							}, {
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/questionType/doAuthUserDel",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/questionType/doAuthOrgUpdate",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
					...
					action : function(dialogItself) {
						...
						BootstrapDialog.show({
							...
							buttons : [{
								...
								action : function(dialogItself) {
									$.ajax({
										url : "home/questionType/doAuthPostUpdate",
										data : params + "&syn2Sub=true",
										success : function(obj) {
											if (!obj.succ) {
												BootstrapDialog.show({
