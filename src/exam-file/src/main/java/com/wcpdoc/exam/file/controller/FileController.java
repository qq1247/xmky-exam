...
public class FileController extends BaseController{
	...
	public String toList() {
		try {
			return "/WEB-INF/jsp/file/file/fileList.jsp";
		} catch (Exception e) {
	...
	public String toUpload() {
		try {
			return "/WEB-INF/jsp/file/file/fileUpload.jsp";
		} catch (Exception e) {
	...
	public PageResult doTempUpload(@RequestParam("files") MultipartFile[] files) {
		try {
			...
			String fileIds = fileService.doTempUpload(files, allowTypes, getCurrentUser(), request.getRemoteAddr());
		...
		try {
			for (Integer id : ids) {
				try {
					...
					fileService.doUpload(id, getCurrentUser(), request.getRemoteAddr());
				} catch (Exception e) {
