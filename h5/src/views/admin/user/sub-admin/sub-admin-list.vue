<template>
    <div class="sub-admin">
        <div class="sub-admin__head">
            <div class="opt">
                <el-button type="success" class="opt__btn" @click="$router.push('/sub-admin-nav/add')">
            ...
            <el-table :data="listpage.list" size="large" row-key="id" height="calc(100vh - 460px)" class="table">
                ...
                <el-table-column prop="name" label="头像" align="center">
                    <template #default="scope">
                        ...
                        <span v-else class="iconfont icon-rentouxiang sub-admin__avatar"></span>
                    </template>
                </el-table-column>
                    ...
                    <template #default="scope">
                        <el-tooltip ffect="dark" content="设置">
                            <span class="iconfont icon-liebiao-01 table__btn"
                                @click="$router.push(`/sub-admin-nav/set/${scope.row.id}`)"></span>
                        </el-tooltip>
                    </template>
                </el-table-column>
            </el-table>
