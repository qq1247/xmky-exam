      ...
      <el-card class="box-card" shadow="never">
        ...
        <div class="data-content">
          ...
          <div class="data-item" @click="">
            ...
            <div class="item-info">
              <span class="info-num">{{userInfo.questionTypeNum}}</span>
              <span class="info-intro">创建题库（个）</span>
            </div>
          </div>
          <div class="data-item" @click="">
            ...
            <div class="item-info">
              <span class="info-num">{{userInfo.questionNum}}</span>
          ...
          <div class="data-item" @click="">
            ...
            <div class="item-info">
              <span class="info-num">{{userInfo.userNum}}</span>
              <span class="info-intro">创建用户（个）</span>
            </div>
          </div>
        </div>
      </el-card>
...
import { getAdminInfo } from 'api/report'
