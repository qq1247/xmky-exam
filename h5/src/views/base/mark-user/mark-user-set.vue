<template>
    <el-scrollbar max-height="calc(100vh - 190px)" class="mark-user-set">
        <xmks-edit-card title="阅卷用户" desc="建议分配一些协助阅卷用户，分别对试卷进行阅卷。">
            <template #card-main>
        ...
        <xmks-edit-card v-if="form.id" title="删除用户" desc="用户阅卷等信息会保留，用于追踪历史。">
            <template #card-side>
...
async function add() {
    ...
    router.push("/base-nav/mark-user-list")
}
