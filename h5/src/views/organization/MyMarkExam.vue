        ...
        <el-row>
          <el-col :span="17">
            <el-form-item label prop="userName">
              <el-input @focus="queryForm.queryShow = true" placeholder="请输入用户名称" v-model="queryForm.userName"></el-input>
            </el-form-item>
      ...
      <div class="table">
        <el-table :data="listpage.list" style="width: 100%">
          ...
          <el-table-column label="分数">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.myExamTotalScore }}</span>
            </template>
          </el-table-column>
          <el-table-column label="状态">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.myExamStateName }}/{{ scope.row.myExamMarkStateName }}</span>
            </template>
          </el-table-column>
