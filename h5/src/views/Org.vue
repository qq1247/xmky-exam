<template>
  <div class="container">
    <div class="content">
      <div class="left">
        <el-tree :data="tree.treeList" @node-click="selTreeNode" accordion default-expand-all highlight-current node-key="id" ref="tree"></el-tree>
      </div>
      <div class="right">
        <div class="search">
        ...
        <div class="table">
          <el-table :data="listpage.list" style="width: 100%">
            ...
            <el-table-column label="上级组织机构">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.PARENT_NAME }}</span>
              </template>
            </el-table-column>
