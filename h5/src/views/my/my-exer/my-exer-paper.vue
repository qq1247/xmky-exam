            ...
            <div class="paper__wrap">
                ...
                <el-scrollbar height="calc(100vh - 269px)" class="paper">
                    ...
                    <xmks-question v-if="curExamQuestion" :id="`q${curQuestionIndex}`"
                        ...
                        :img-ids="curExamQuestion.imgFileIds" :video-id="curExamQuestion.videoFileId"
                        :options="curExamQuestion.options" :answers="curExamQuestion.answers"
                        :markType="curExamQuestion.markType as number" :score="curExamQuestion.score as number"
                        :scores="curExamQuestion.scores" :analysis="curExamQuestion.analysis"
                        :userAnswers="curExamQuestion.userAnswers" :userScore="curExamQuestion.userScore"
