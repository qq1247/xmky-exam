            ...
            <div class="notes">
                ...
                <div class="notes__main">
                    <span class="notes__txt">
                        1、考试结束时间到，系统会自动 交卷。请注意把握时间。<br /> 2、交卷后不可再次考试，请慎重! 系统会自动交卷。
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="my-exam">
                ...
                <div class="my-exam__main">
                    <div class="my-exam__state">
                        <span class="my-exam__state-label">考试状态：</span>
                    ...
                    <div class="my-exam__outer">
                        <div class="my-exam__inner">
                            ...
                            <span class="myexam__label">
                                考试分数：<span class="myexam__value">{{ myExam.objectiveScore != null ?
                                    myExam.objectiveScore : '-' }}/{{ myExam.totalScore != null ? myExam.totalScore :
                                        '-' }}（客观分/合计）</span>
                            </span>
                            <span class="myexam__label">
...
import { myExamExamGet, myExamGet, myExamQuestionStatis } from '@/api/my/my-exam'
