...
export default {
  ...
  examTypeAuth: (params) => post('examType/auth', params),
  ...
  paperPublish: (params) => post('paper/publish', params),
  ...
  paperUpdateScore: (params) => post('paper/updateScore', params),
  paperUpdateScoreOptions: (params) => post('paper/updateScoreOptions', params),
  ...
  paperTypeAuth: (params) => post('paperType/auth', params),
  ...
  // 试题分类开放相关
  questionTypeOpenListPage: (params) =>
    post('questionTypeOpen/listpage', params),
