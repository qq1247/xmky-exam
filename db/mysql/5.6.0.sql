...
drop table if exists EXM_MY_QUESTION_HIS;
...
(
   ...
   LOGIN_TYPE           int comment '登录方式（1：正常登录；2：免登录；）数据字典：LOGIN_TYPE',
...
INSERT INTO `SYS_DICT` VALUES (56, 'LOGIN_TYPE', '1', '正常登录', 1);
INSERT INTO `SYS_DICT` VALUES (57, 'LOGIN_TYPE', '2', '免登录', 2);
