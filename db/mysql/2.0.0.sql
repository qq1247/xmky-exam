...
(
   ...
   SCORE_OPTIONS        varchar(8) comment '1：半对半分；2：答案无顺序；3：大小写不敏感；4：包含答案得分',
   VER                  int comment '版本',
...
(
   ...
   SCORE_STATE          int comment '1：公开；2：不公开',
   RANK_STATE           int comment '1：公开；2：不公开',
   LOGIN_TYPE           int comment '1：安排考试；2：免登陆考试',
